...
include "m8c.inc"
include "memory.inc"
include "TX_REPEATER.inc"

area UserModules (ROM, REL)
;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export   TX_REPEATER_SetTxIntMode
export  _TX_REPEATER_SetTxIntMode
export   TX_REPEATER_EnableInt
export  _TX_REPEATER_EnableInt
export   TX_REPEATER_DisableInt
export  _TX_REPEATER_DisableInt
export   TX_REPEATER_Start
export  _TX_REPEATER_Start
export   TX_REPEATER_Stop
export  _TX_REPEATER_Stop
export   TX_REPEATER_SendData
export  _TX_REPEATER_SendData
export   TX_REPEATER_bReadTxStatus
export  _TX_REPEATER_bReadTxStatus

// Old labels, will be removed in future release
// Do Not Use.
export   bTX_REPEATER_ReadTxStatus
export  _bTX_REPEATER_ReadTxStatus

;-----------------------------------------------
;  High Level TX functions
;-----------------------------------------------
export  TX_REPEATER_PutSHexByte
export _TX_REPEATER_PutSHexByte
export  TX_REPEATER_PutSHexInt
export _TX_REPEATER_PutSHexInt

export  TX_REPEATER_CPutString
export _TX_REPEATER_CPutString
export  TX_REPEATER_PutString
export _TX_REPEATER_PutString
export  TX_REPEATER_PutChar
export _TX_REPEATER_PutChar
export  TX_REPEATER_Write
export _TX_REPEATER_Write
export  TX_REPEATER_CWrite
export _TX_REPEATER_CWrite
export  TX_REPEATER_PutCRLF
export _TX_REPEATER_PutCRLF 
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_REPEATER_EnableInt
;
;  DESCRIPTION:
...
;    functions.
;
 TX_REPEATER_EnableInt:
_TX_REPEATER_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_EnableIntMask  TX_REPEATER_INT_REG, TX_REPEATER_bINT_MASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_REPEATER_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 TX_REPEATER_DisableInt:
_TX_REPEATER_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_DisableIntMask TX_REPEATER_INT_REG, TX_REPEATER_bINT_MASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_REPEATER_SetTxIntMode(BYTE bTxIntMode)
;
;  DESCRIPTION:
...
;
 TX_REPEATER_SetTxIntMode:
_TX_REPEATER_SetTxIntMode:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_SetBank1
   and   A, TX_REPEATER_INT_MODE_TX_COMPLETE
   jz    .SetModeRegEmpty
   or    REG[TX_REPEATER_FUNC_REG], bfFUNCTION_REG_TX_INT_MODE_BIT
   M8C_SetBank0
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret

.SetModeRegEmpty:
   and   REG[TX_REPEATER_FUNC_REG], ~bfFUNCTION_REG_TX_INT_MODE_BIT
   M8C_SetBank0
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_REPEATER_Start(BYTE bParity)
;
;  DESCRIPTION:
...
_TX_REPEATER_Start:
   ...
   mov   REG[TX_REPEATER_CONTROL_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_REPEATER_Stop
;
;  DESCRIPTION:
...
_TX_REPEATER_Stop:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   REG[TX_REPEATER_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_REPEATER_SendData
;
;  DESCRIPTION:
...
;    functions.
;
 TX_REPEATER_SendData:
_TX_REPEATER_SendData:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov REG[TX_REPEATER_TX_BUFFER_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_REPEATER_bReadTxStatus
;
;  DESCRIPTION:
...
;    functions.
;
 TX_REPEATER_bReadTxStatus:
_TX_REPEATER_bReadTxStatus:
 bTX_REPEATER_ReadTxStatus:
_bTX_REPEATER_ReadTxStatus:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A,  REG[TX_REPEATER_CONTROL_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_REPEATER_PutSHexByte
;
;  DESCRIPTION:
...
.SECTION
 TX_REPEATER_PutSHexByte:
_TX_REPEATER_PutSHexByte:
    RAM_PROLOGUE RAM_USE_CLASS_1
    ...
    index TX_REPEATER_HEX_STR          ; Get Hex value
    call  TX_REPEATER_PutChar          ; Write data to screen
    pop   A                            ; Restore value
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_REPEATER_PutSHexInt
;
;  DESCRIPTION:
...
;    functions.
;
 TX_REPEATER_PutSHexInt:
_TX_REPEATER_PutSHexInt:
    RAM_PROLOGUE RAM_USE_CLASS_1
    swap  A,X
    call  TX_REPEATER_PutSHexByte      ; Print MSB
    mov   A,X                          ; Move LSB into position
    call  TX_REPEATER_PutSHexByte      ; Print LSB
    RAM_EPILOGUE RAM_USE_CLASS_1
    ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_REPEATER_PutChar
;
;  DESCRIPTION:
...
.BufEmptyWaitLoop:
   tst REG[TX_REPEATER_CONTROL_REG], TX_REPEATER_TX_BUFFER_EMPTY    ; Check Tx Status
   jz  .BufEmptyWaitLoop
   mov REG[TX_REPEATER_TX_BUFFER_REG], @Source    ; Write data to Tx Port
   endm


 TX_REPEATER_PutChar:
_TX_REPEATER_PutChar:
   RAM_PROLOGUE RAM_USE_CLASS_1
   InLinePutChar A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_REPEATER_PutString
;
;  DESCRIPTION:
...
;          IDX_PP
;
 TX_REPEATER_PutString:
_TX_REPEATER_PutString:
   RAM_PROLOGUE RAM_USE_CLASS_3
   RAM_SETPAGE_IDX A
.PutStringLoop:
   mov   A,[X]                             ; Get value pointed to by X
   jz    End_PutString                     ; Check for end of string
   call  TX_REPEATER_PutChar                ; Send character to Tx port
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_REPEATER_Write
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_REPEATER_CWrite
;
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_REPEATER_CPutString
;
;  DESCRIPTION:
;     Send String out through UART TX port.
;
...
;    functions.
;
 TX_REPEATER_CPutString:
_TX_REPEATER_CPutString:
   RAM_PROLOGUE RAM_USE_CLASS_1   
   push  A                                       ; Store ROM pointer
   push  X
   romx                                          ; Get character from ROM
   jz    .End_CPutString
   call  TX_REPEATER_PutChar                ; Print character
   pop   X
   pop   A
   inc   X                                       ; Inc LSB of pointer
   jnc   TX_REPEATER_CPutString                  ; Check for carry
   inc   A                                       ; Inc MSB of pointer
   jmp   TX_REPEATER_CPutString
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_REPEATER_PutCRLF
;
;  DESCRIPTION:
;     Send a CR and LF
;
...
;
 TX_REPEATER_PutCRLF:
_TX_REPEATER_PutCRLF:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov  A,0x0D                        ; Send CR
   call TX_REPEATER_PutChar
   mov  A,0x0A                        ; Send LF
   call TX_REPEATER_PutChar
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
