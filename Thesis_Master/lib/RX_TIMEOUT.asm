...
include "m8c.inc"
include "memory.inc"
include "RX_TIMEOUT.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  RX_TIMEOUT_EnableInt
export _RX_TIMEOUT_EnableInt
export  RX_TIMEOUT_DisableInt
export _RX_TIMEOUT_DisableInt
export  RX_TIMEOUT_Start
export _RX_TIMEOUT_Start
export  RX_TIMEOUT_Stop
export _RX_TIMEOUT_Stop
export  RX_TIMEOUT_WritePeriod
export _RX_TIMEOUT_WritePeriod
export  RX_TIMEOUT_WriteCompareValue
export _RX_TIMEOUT_WriteCompareValue
export  RX_TIMEOUT_wReadCompareValue
export _RX_TIMEOUT_wReadCompareValue
export  RX_TIMEOUT_wReadTimer
export _RX_TIMEOUT_wReadTimer
export  RX_TIMEOUT_wReadTimerSaveCV
export _RX_TIMEOUT_wReadTimerSaveCV

; The following functions are deprecated and subject to omission in future releases
;
export  wRX_TIMEOUT_ReadCompareValue  ; deprecated
export _wRX_TIMEOUT_ReadCompareValue  ; deprecated
export  wRX_TIMEOUT_ReadTimer         ; deprecated
export _wRX_TIMEOUT_ReadTimer         ; deprecated
export  wRX_TIMEOUT_ReadTimerSaveCV   ; deprecated
export _wRX_TIMEOUT_ReadTimerSaveCV   ; deprecated

export  wRX_TIMEOUT_ReadCounter       ; obsolete
export _wRX_TIMEOUT_ReadCounter       ; obsolete
export  wRX_TIMEOUT_CaptureCounter    ; obsolete
export _wRX_TIMEOUT_CaptureCounter    ; obsolete


AREA receiver_config_RAM (RAM,REL)
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RX_TIMEOUT_EnableInt
;
;  DESCRIPTION:
...
_RX_TIMEOUT_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   RX_TIMEOUT_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RX_TIMEOUT_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 RX_TIMEOUT_DisableInt:
_RX_TIMEOUT_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   RX_TIMEOUT_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RX_TIMEOUT_Start
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RX_TIMEOUT_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 RX_TIMEOUT_WritePeriod:
_RX_TIMEOUT_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[RX_TIMEOUT_PERIOD_LSB_REG], A
   mov   A, X
   mov   reg[RX_TIMEOUT_PERIOD_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
;    functions.
;
 RX_TIMEOUT_WriteCompareValue:
_RX_TIMEOUT_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[RX_TIMEOUT_COMPARE_LSB_REG], A
   mov   A, X
   mov   reg[RX_TIMEOUT_COMPARE_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RX_TIMEOUT_wReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 RX_TIMEOUT_wReadCompareValue:
_RX_TIMEOUT_wReadCompareValue:
 wRX_TIMEOUT_ReadCompareValue:                   ; this name deprecated
_wRX_TIMEOUT_ReadCompareValue:                   ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[RX_TIMEOUT_COMPARE_MSB_REG]
   mov   X, A
   mov   A, reg[RX_TIMEOUT_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RX_TIMEOUT_wReadTimerSaveCV
;
;  DESCRIPTION:
...
;
 RX_TIMEOUT_wReadTimerSaveCV:
_RX_TIMEOUT_wReadTimerSaveCV:
 wRX_TIMEOUT_ReadTimerSaveCV:                    ; this name deprecated
_wRX_TIMEOUT_ReadTimerSaveCV:                    ; this name deprecated
 wRX_TIMEOUT_ReadCounter:                        ; this name deprecated
_wRX_TIMEOUT_ReadCounter:                        ; this name deprecated
...
wCount_LSB:    equ   2
   ...
   mov   A, reg[RX_TIMEOUT_CONTROL_LSB_REG]      ; save the Control register
   push  A
   mov   A, reg[RX_TIMEOUT_COMPARE_LSB_REG]      ; save the Compare register
   push  A
   mov   A, reg[RX_TIMEOUT_COMPARE_MSB_REG]
   push  A
   mov   A, reg[RX_TIMEOUT_COUNTER_LSB_REG]      ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[RX_TIMEOUT_COMPARE_MSB_REG]      ; Now grab DR2 (DR0) and save
   mov   [X+wCount_MSB], A
   mov   A, reg[RX_TIMEOUT_COMPARE_LSB_REG]
   mov   [X+wCount_LSB], A
...
.SetupStatusFlag:                                ; and ...
   ...
   RX_TIMEOUT_Stop_M                             ; Disable (stop) the timer
   pop   A                                       ; Restore the Compare register
   mov   reg[RX_TIMEOUT_COMPARE_MSB_REG], A
   pop   A
   mov   reg[RX_TIMEOUT_COMPARE_LSB_REG], A
   pop   A                                       ; restore start state of the timer
   mov   reg[RX_TIMEOUT_CONTROL_LSB_REG], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RX_TIMEOUT_wReadTimer
;
;  DESCRIPTION:
...
;
 RX_TIMEOUT_wReadTimer:
_RX_TIMEOUT_wReadTimer:
 wRX_TIMEOUT_ReadTimer:                          ; this name deprecated
_wRX_TIMEOUT_ReadTimer:                          ; this name deprecated
 wRX_TIMEOUT_CaptureCounter:                     ; this name deprecated
_wRX_TIMEOUT_CaptureCounter:                     ; this name deprecated

   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[RX_TIMEOUT_COUNTER_LSB_REG]      ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!

   mov   A, reg[RX_TIMEOUT_COMPARE_MSB_REG]      ; Return DR2 (actually DR0)
   mov   X, A
   mov   A, reg[RX_TIMEOUT_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
