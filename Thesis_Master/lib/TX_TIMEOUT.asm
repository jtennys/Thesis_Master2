...
include "m8c.inc"
include "memory.inc"
include "TX_TIMEOUT.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  TX_TIMEOUT_EnableInt
export _TX_TIMEOUT_EnableInt
export  TX_TIMEOUT_DisableInt
export _TX_TIMEOUT_DisableInt
export  TX_TIMEOUT_Start
export _TX_TIMEOUT_Start
export  TX_TIMEOUT_Stop
export _TX_TIMEOUT_Stop
export  TX_TIMEOUT_WritePeriod
export _TX_TIMEOUT_WritePeriod
export  TX_TIMEOUT_WriteCompareValue
export _TX_TIMEOUT_WriteCompareValue
export  TX_TIMEOUT_wReadCompareValue
export _TX_TIMEOUT_wReadCompareValue
export  TX_TIMEOUT_wReadTimer
export _TX_TIMEOUT_wReadTimer
export  TX_TIMEOUT_wReadTimerSaveCV
export _TX_TIMEOUT_wReadTimerSaveCV

; The following functions are deprecated and subject to omission in future releases
;
export  wTX_TIMEOUT_ReadCompareValue  ; deprecated
export _wTX_TIMEOUT_ReadCompareValue  ; deprecated
export  wTX_TIMEOUT_ReadTimer         ; deprecated
export _wTX_TIMEOUT_ReadTimer         ; deprecated
export  wTX_TIMEOUT_ReadTimerSaveCV   ; deprecated
export _wTX_TIMEOUT_ReadTimerSaveCV   ; deprecated

export  wTX_TIMEOUT_ReadCounter       ; obsolete
export _wTX_TIMEOUT_ReadCounter       ; obsolete
export  wTX_TIMEOUT_CaptureCounter    ; obsolete
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_TIMEOUT_EnableInt
;
;  DESCRIPTION:
...
;    functions.
;
 TX_TIMEOUT_EnableInt:
_TX_TIMEOUT_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   TX_TIMEOUT_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_TIMEOUT_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 TX_TIMEOUT_DisableInt:
_TX_TIMEOUT_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   TX_TIMEOUT_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_TIMEOUT_Start
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_TIMEOUT_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 TX_TIMEOUT_WritePeriod:
_TX_TIMEOUT_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[TX_TIMEOUT_PERIOD_LSB_REG], A
   mov   A, X
   mov   reg[TX_TIMEOUT_PERIOD_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
;    functions.
;
 TX_TIMEOUT_WriteCompareValue:
_TX_TIMEOUT_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[TX_TIMEOUT_COMPARE_LSB_REG], A
   mov   A, X
   mov   reg[TX_TIMEOUT_COMPARE_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_TIMEOUT_wReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 TX_TIMEOUT_wReadCompareValue:
_TX_TIMEOUT_wReadCompareValue:
 wTX_TIMEOUT_ReadCompareValue:                   ; this name deprecated
_wTX_TIMEOUT_ReadCompareValue:                   ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[TX_TIMEOUT_COMPARE_MSB_REG]
   mov   X, A
   mov   A, reg[TX_TIMEOUT_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_TIMEOUT_wReadTimerSaveCV
;
;  DESCRIPTION:
...
;
 TX_TIMEOUT_wReadTimerSaveCV:
_TX_TIMEOUT_wReadTimerSaveCV:
 wTX_TIMEOUT_ReadTimerSaveCV:                    ; this name deprecated
_wTX_TIMEOUT_ReadTimerSaveCV:                    ; this name deprecated
 wTX_TIMEOUT_ReadCounter:                        ; this name deprecated
_wTX_TIMEOUT_ReadCounter:                        ; this name deprecated
...
wCount_LSB:    equ   2
   ...
   mov   A, reg[TX_TIMEOUT_CONTROL_LSB_REG]      ; save the Control register
   push  A
   mov   A, reg[TX_TIMEOUT_COMPARE_LSB_REG]      ; save the Compare register
   push  A
   mov   A, reg[TX_TIMEOUT_COMPARE_MSB_REG]
   push  A
   mov   A, reg[TX_TIMEOUT_COUNTER_LSB_REG]      ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[TX_TIMEOUT_COMPARE_MSB_REG]      ; Now grab DR2 (DR0) and save
   mov   [X+wCount_MSB], A
   mov   A, reg[TX_TIMEOUT_COMPARE_LSB_REG]
   mov   [X+wCount_LSB], A
...
.SetupStatusFlag:                                ; and ...
   ...
   TX_TIMEOUT_Stop_M                             ; Disable (stop) the timer
   pop   A                                       ; Restore the Compare register
   mov   reg[TX_TIMEOUT_COMPARE_MSB_REG], A
   pop   A
   mov   reg[TX_TIMEOUT_COMPARE_LSB_REG], A
   pop   A                                       ; restore start state of the timer
   mov   reg[TX_TIMEOUT_CONTROL_LSB_REG], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_TIMEOUT_wReadTimer
;
;  DESCRIPTION:
...
;
 TX_TIMEOUT_wReadTimer:
_TX_TIMEOUT_wReadTimer:
 wTX_TIMEOUT_ReadTimer:                          ; this name deprecated
_wTX_TIMEOUT_ReadTimer:                          ; this name deprecated
 wTX_TIMEOUT_CaptureCounter:                     ; this name deprecated
_wTX_TIMEOUT_CaptureCounter:                     ; this name deprecated

   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[TX_TIMEOUT_COUNTER_LSB_REG]      ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!

   mov   A, reg[TX_TIMEOUT_COMPARE_MSB_REG]      ; Return DR2 (actually DR0)
   mov   X, A
   mov   A, reg[TX_TIMEOUT_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
